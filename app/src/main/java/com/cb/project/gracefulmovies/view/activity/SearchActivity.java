...
import com.cb.project.gracefulmovies.model.MovieSearchModel;
import com.cb.project.gracefulmovies.presenter.ISearchActivityPresenter;
import com.cb.project.gracefulmovies.presenter.impl.SearchActivityPresenterImpl;
import com.cb.project.gracefulmovies.view.adapter.SearchCastAdapter;
import com.cb.project.gracefulmovies.view.iview.ISearchActivity;
import com.cb.project.gracefulmovies.view.widget.TagGroup;
...
public class SearchActivity extends BaseActivity implements ISearchActivity {
    ...
    @BindView(com.cb.project.gracefulmovies.R.id.search_base_info_layout)
    View mBaseInfoLayout;
    @BindView(com.cb.project.gracefulmovies.R.id.search_root_layout)
    LinearLayout mRootLayout;
    @BindView(com.cb.project.gracefulmovies.R.id.place_holder_hint_text)
    VectorCompatTextView mPlaceHolderHintText;
    @BindView(com.cb.project.gracefulmovies.R.id.place_holder_container)
    View mPlaceHolderContainer;
    @BindView(com.cb.project.gracefulmovies.R.id.search_poster_img)
    AppCompatImageView mPosterImg;
    @BindView(com.cb.project.gracefulmovies.R.id.search_name_text)
    TextView mNameText;
    @BindView(com.cb.project.gracefulmovies.R.id.search_type_container)
    TagGroup mTypeContainer;
    @BindView(com.cb.project.gracefulmovies.R.id.search_rating_bar)
    SimpleRatingBar mRatingBar;
    @BindView(com.cb.project.gracefulmovies.R.id.search_grade_text)
    TextView mGradeText;
    @BindView(com.cb.project.gracefulmovies.R.id.search_director_text)
    TextView mDirectorText;
    @BindView(com.cb.project.gracefulmovies.R.id.search_scroll_view)
    ScrollView mScrollView;
    @BindView(com.cb.project.gracefulmovies.R.id.search_story_brief_text)
    TextView mStoryBriefText;
    @BindView(com.cb.project.gracefulmovies.R.id.search_cast_recycler_view)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cb.project.gracefulmovies.R.layout.activity_search);
        ButterKnife.bind(this);

        initializeToolbar();
        mPlaceHolderHintText.setText(getString(com.cb.project.gracefulmovies.R.string.hint_movie_search));
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.cb.project.gracefulmovies.R.menu.search, menu);

        final MenuItem item = menu.findItem(com.cb.project.gracefulmovies.R.id.action_search);
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (mPlaceHolderHintText.getVisibility() == View.VISIBLE) {
                    mPlaceHolderHintText.setText(getString(com.cb.project.gracefulmovies.R.string.data_loading));
                }
                hideInputMethod();
        ...
        if (Colorful.getThemeDelegate().isNight()) {
            mAdapter = new ArrayAdapter<>(this, com.cb.project.gracefulmovies.R.layout.layout_search_hint_night, new ArrayList<String>());
        } else {
            mAdapter = new ArrayAdapter<>(this, com.cb.project.gracefulmovies.R.layout.layout_search_hint_day, new ArrayList<String>());
        }
    ...
    @OnClick({com.cb.project.gracefulmovies.R.id.search_root_layout, com.cb.project.gracefulmovies.R.id.search_base_info_layout, com.cb.project.gracefulmovies.R.id.search_more_info_layout})
    public void onClick() {
        hideInputMethod();
    }
    ...
    public void onDisplayUI(MovieSearchModel model) {
        ...
        if (Colorful.getThemeDelegate().isNight()) {
            mScrollView.setBackgroundColor(ContextCompat.getColor(this, com.cb.project.gracefulmovies.R.color.color_background_night));
        } else {
            mScrollView.setBackgroundColor(ContextCompat.getColor(this, com.cb.project.gracefulmovies.R.color.color_background_day));
        }

        mNameText.setText(model.getTitle());
        Glide.with(this).load(model.getCover()).error(com.cb.project.gracefulmovies.R.drawable.svg_ic_loading).into(mPosterImg);
    ...
    public void onDataFailed(String msg) {
        ...
        mPlaceHolderHintText.setText(getString(com.cb.project.gracefulmovies.R.string.has_no_data));
