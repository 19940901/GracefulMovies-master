...
public abstract class CheckPermissionsActivity extends ColorfulActivity implements
    ...
    private void showMissingPermissionDialog() {
        ...
        builder.setTitle(com.cb.project.gracefulmovies.R.string.permission_title);
        builder.setMessage(com.cb.project.gracefulmovies.R.string.permission_msg);

        builder.setNegativeButton(com.cb.project.gracefulmovies.R.string.cancel, null);
        builder.setPositiveButton(com.cb.project.gracefulmovies.R.string.settings,
