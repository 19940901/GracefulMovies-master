package com.cb.project.gracefulmovies.view.service;
                ...
                public void onNext(NetLocResult netLocResult) {
                    ...
                    if (netLocResult.getUpperCity() != null && !netLocResult.getUpperCity().isEmpty()) {
                        ...
                        if (!PrefUtil.isInputtedCity() && diffUpper && !newCity.equals(PrefUtil.getCity())) {
                            ...
                            LocalBroadcastManager.getInstance(LocationService.this).sendBroadcast(new Intent(getString(com.cb.project.gracefulmovies.R.string.action_locate_succeed)));
