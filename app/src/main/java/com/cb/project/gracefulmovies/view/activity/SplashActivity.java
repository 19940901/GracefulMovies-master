...
import com.cb.project.gracefulmovies.server.ApiHelper;
import com.cb.project.gracefulmovies.util.Logy;
...
public class SplashActivity extends AppCompatActivity {
    ...
    @BindView(com.cb.project.gracefulmovies.R.id.splash_root_layout)
    RelativeLayout mRootLayout;
    @BindView(com.cb.project.gracefulmovies.R.id.splash_bg_img)
    KenBurnsView mBgImg;
    @BindView(com.cb.project.gracefulmovies.R.id.splash_logo_img)
    AppCompatImageView mLogoImg;
    @BindView(com.cb.project.gracefulmovies.R.id.splash_app_name_text)
    TextView mAppNameText;
    @BindView(com.cb.project.gracefulmovies.R.id.splash_app_slogan_text)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cb.project.gracefulmovies.R.layout.activity_splash);
        ...
        Glide.with(this).load(com.cb.project.gracefulmovies.R.drawable.pic_bg_main).into(mBgImg);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Logy.init(true);
                String s1 = "950923ede0a193793a5192114c859ec5"; // 聚合Api Key
                String s2 = "73e9da538db1d6eba12af7655f00083a"; // 神剑 Id
                 // 易源Api Key
                ApiHelper.init(s1, s2); // TODO: 2017-02-24 add your api key to request data
