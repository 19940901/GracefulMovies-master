...
import com.cb.project.gracefulmovies.view.activity.MovieDetailActivity;
import com.iarcuschin.simpleratingbar.SimpleRatingBar;
import com.cb.project.gracefulmovies.R;
import com.cb.project.gracefulmovies.model.MovieModel;
import com.cb.project.gracefulmovies.view.activity.BaseActivity;
import com.cb.project.gracefulmovies.view.activity.MovieDetailActivity;
import com.cb.project.gracefulmovies.view.widget.AutoFitSizeTextView;
...
public class MovieListAdapter extends BaseRecyclerAdapter<MovieModel, MovieListAdapter.MovieVH> {
    ...
    protected MovieVH onCreate(LayoutInflater inflater, ViewGroup parent, int viewType) {
        return new MovieVH(inflater.inflate(com.cb.project.gracefulmovies.R.layout.item_movie, parent, false));
    }
    ...
    protected void onBind(final MovieVH holder, int position) {
        ...
        Glide.with(mContext)
                ...
                .placeholder(com.cb.project.gracefulmovies.R.drawable.pic_place_holder)
                .error(com.cb.project.gracefulmovies.R.drawable.pic_place_holder)
    ...
    public static class MovieVH extends BaseRecyclerViewHolder {
        ...
        MovieVH(View itemView) {
            ...
            mPosterImg = findView(com.cb.project.gracefulmovies.R.id.movie_poster_img);
            mNameText = findView(com.cb.project.gracefulmovies.R.id.movie_name_text);
            mOpenInfoImg = findView(com.cb.project.gracefulmovies.R.id.movie_open_info_img);
            mInfoLayout = findView(com.cb.project.gracefulmovies.R.id.movie_info_layout);
            tagContainer = findView(com.cb.project.gracefulmovies.R.id.movie_type_container);
            ratingBar = findView(com.cb.project.gracefulmovies.R.id.movie_rating_bar);
            gradeText = findView(com.cb.project.gracefulmovies.R.id.movie_grade_text);
            releaseDateText = findView(com.cb.project.gracefulmovies.R.id.movie_release_date_text);
            castText = findView(com.cb.project.gracefulmovies.R.id.movie_cast_text);
        }
    }
}
