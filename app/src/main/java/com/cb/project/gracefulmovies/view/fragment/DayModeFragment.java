...
public class DayModeFragment extends SideFragment {
    ...
    void displayUI() {
        ...
        mToolbar.setTitle(getString(com.cb.project.gracefulmovies.R.string.day_mode));
        ...
        if (mHandler == null) {
            ...
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Glide.with(getActivity()).load(com.cb.project.gracefulmovies.R.drawable.pic_day).into(mHeaderImg);
        ...
        mDayNightModeText.setTextColor(ContextCompat.getColor(getContext(), com.cb.project.gracefulmovies.R.color.color_text_primary_dark));
        mPrimaryColorText.setTextColor(ContextCompat.getColor(getContext(), com.cb.project.gracefulmovies.R.color.color_text_primary_dark));
        mAccentColorText.setTextColor(ContextCompat.getColor(getContext(), com.cb.project.gracefulmovies.R.color.color_text_primary_dark));
