...
import com.cb.project.gracefulmovies.model.OpenModel;
import com.cb.project.gracefulmovies.view.widget.QuoteTextView;
...
public class LicenseListAdapter extends BaseRecyclerAdapter<OpenModel, LicenseListAdapter.LicenseVH> {
    ...
    protected LicenseVH onCreate(LayoutInflater inflater, ViewGroup parent, int viewType) {
        return new LicenseVH(inflater.inflate(com.cb.project.gracefulmovies.R.layout.item_license, parent, false));
    }
    ...
    class LicenseVH extends BaseRecyclerViewHolder {
        ...
        LicenseVH(View itemView) {
            ...
            sourceText = findView(com.cb.project.gracefulmovies.R.id.open_source_text);
            licenseText = findView(com.cb.project.gracefulmovies.R.id.open_license_text);
        }
    }
