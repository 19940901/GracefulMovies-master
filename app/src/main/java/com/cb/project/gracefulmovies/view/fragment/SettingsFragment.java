package com.cb.project.gracefulmovies.view.fragment;
...
import com.cb.project.gracefulmovies.util.SharedPrefHelper;
import com.cb.project.gracefulmovies.view.activity.BaseActivity;
import com.cb.project.gracefulmovies.view.activity.ThemeActivity;
...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.cb.project.gracefulmovies.R.xml.settings);

        SwitchPreference switchPref = (SwitchPreference) findPreference(getString(com.cb.project.gracefulmovies.R.string.key_auto_day_night));
        mDayTimePref = findPreference(getString(com.cb.project.gracefulmovies.R.string.key_day_mode_time));
        mNightTimePref = findPreference(getString(com.cb.project.gracefulmovies.R.string.key_night_mode_time));
        mCachePreference = findPreference(getString(com.cb.project.gracefulmovies.R.string.key_cache));
        ...
        int h = time[0];
        int m = time[1];
        mDayTimePref.setSummary(getString(com.cb.project.gracefulmovies.R.string.format_hour_min2, formatTime(h), formatTime(m)));
        time = PrefUtil.getDayNightModeStartTime(false);
        h = time[0];
        m = time[1];
        mNightTimePref.setSummary(getString(com.cb.project.gracefulmovies.R.string.format_hour_min2, formatTime(h), formatTime(m)));
        ...
        findPreference(getString(com.cb.project.gracefulmovies.R.string.key_theme)).setOnPreferenceClickListener(this);
        mCachePreference.setOnPreferenceClickListener(this);
        findPreference(getString(com.cb.project.gracefulmovies.R.string.key_feedback)).setOnPreferenceClickListener(this);
    }
    ...
    public boolean onPreferenceClick(Preference preference) {
        switch (preference.getOrder()) {
            ...
            case 5:
                ...
                intent.setData(Uri.parse(getString(com.cb.project.gracefulmovies.R.string.questionnaire_url)));
    ...
    private void showPickTimeDialog(final boolean isDay) {
        ...
        View view = getActivity().getLayoutInflater().inflate(com.cb.project.gracefulmovies.R.layout.layout_pick_time_dialog, null);
        final TextView hourMinText = (TextView) view.findViewById(com.cb.project.gracefulmovies.R.id.dialog_hour_min_text);
        final BubbleSeekBar hourBar = (BubbleSeekBar) view.findViewById(com.cb.project.gracefulmovies.R.id.dialog_hour_seek_bar);
        final BubbleSeekBar minBar = (BubbleSeekBar) view.findViewById(com.cb.project.gracefulmovies.R.id.dialog_min_seek_bar);

        int[] time = PrefUtil.getDayNightModeStartTime(isDay);
        int h = time[0];
        int m = time[1];

        hourMinText.setText(getString(com.cb.project.gracefulmovies.R.string.format_hour_min, formatTime(h), formatTime(m)));
        ...
        hourBar.setOnProgressChangedListener(new BubbleSeekBar.OnProgressChangedListenerAdapter() {
            ...
            public void onProgressChanged(BubbleSeekBar bubbleSeekBar, int progress, float progressFloat) {
                hourMinText.setText(getString(com.cb.project.gracefulmovies.R.string.format_hour_min, formatTime(progress),
        ...
        minBar.setOnProgressChangedListener(new BubbleSeekBar.OnProgressChangedListenerAdapter() {
            @Override
            public void onProgressChanged(BubbleSeekBar bubbleSeekBar, int progress, float progressFloat) {
                hourMinText.setText(getString(com.cb.project.gracefulmovies.R.string.format_hour_min,
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (isDay) {
                    SharedPrefHelper.putString(getString(com.cb.project.gracefulmovies.R.string.key_day_mode_time), s);
                    mDayTimePref.setSummary(s);
                } else {
                    SharedPrefHelper.putString(getString(com.cb.project.gracefulmovies.R.string.key_night_mode_time), s);
