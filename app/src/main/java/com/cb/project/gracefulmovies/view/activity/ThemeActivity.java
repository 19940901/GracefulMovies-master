...
import com.cb.project.gracefulmovies.view.fragment.DayModeFragment;
import com.cb.project.gracefulmovies.view.fragment.NightModeFragment;
...
public class ThemeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cb.project.gracefulmovies.R.layout.activity_theme);

        if (savedInstanceState == null) {
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            if (Colorful.getThemeDelegate().isNight()) {
                ft.add(com.cb.project.gracefulmovies.R.id.container, NightModeFragment.newInstance(), NightModeFragment.TAG);
            } else {
                ft.add(com.cb.project.gracefulmovies.R.id.container, DayModeFragment.newInstance(), DayModeFragment.TAG);
            }
            ft.commit();
        }
    }
    ...
    public void switchModeFragment(int cx, int cy, boolean appBarExpanded, String which) {
        ...
        ft.add(com.cb.project.gracefulmovies.R.id.container, fragment, which).commit();
    }
